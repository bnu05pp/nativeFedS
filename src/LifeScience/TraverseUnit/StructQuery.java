...
public class StructQuery {
	...
	public void GenerateSubGraph(ArrayList<Integer> Keyword, InitialHelper iHelper) throws IOException {
	...
	public void done(InitialHelper iHelper, ArrayList<Integer> Keyword) throws IOException {
		// Keyword.add(198);
		// Keyword.add(258);
