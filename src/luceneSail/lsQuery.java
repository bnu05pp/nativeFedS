...
public class lsQuery {
	...
	public static HashMap<String,String> exExecute(String kw)
	{
		...
		try {
			...
			query = new exConnection().getExConn().prepareTupleQuery(QueryLanguage.SPARQL, queryString);
			...
			while (result.hasNext()){
				...
				for (Binding binding : bindings) {
					...
					sMap.put("<"+binding.getValue().toString()+">",kw);
				}
			}
	...
	/*
		//example
		public static String exQuery(String qs)
		{
			String lastResult="";
