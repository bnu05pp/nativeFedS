...
public class jamendoConnection {
		public static SailRepositoryConnection jamendoConn=null;
		public static SailRepository repository=null;
		
		public static void openJamendoConn() throws RepositoryException, RDFParseException, IOException
		{
			String index_path = "/home/LuceneSailIndex/jamendo";
...
//			lucenesail.setParameter(LuceneSail.LUCENE_DIR_KEY, "true");
			...
			lucenesail.setParameter(LuceneSail.LUCENE_DIR_KEY, "/home/LuceneSailKey/jamendo");
			...
			jamendoConn= repository.getConnection();
			// connection.begin();
			
				// connection.setAutoCommit(false);
				// System.out.println(System.getProperty("user.dir"));  
				
//				String in_file_path = "/home/daven/jamendo.nt";
...
//				jamendoConn.add(file, "", RDFFormat.NTRIPLES);
				jamendoConn.commit();
				
				System.out.println("------ jamendo文件已生成 -----");
		}
		
		public static SailRepositoryConnection getJamendoConn()
		{
